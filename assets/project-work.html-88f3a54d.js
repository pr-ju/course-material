...
const _hoisted_17 = { class: "custom-container warning" };
const _hoisted_18 = { class: "custom-container tip" };
const _hoisted_19 = {
...
const _hoisted_23 = { class: "custom-container danger" };
const _hoisted_24 = {
...
const _hoisted_29 = { class: "custom-container warning" };
const _hoisted_30 = {
  href: "https://www.npmjs.com/package/nodemon",
  target: "_blank",
  rel: "noopener noreferrer"
};
const _hoisted_31 = { class: "custom-container tip" };
const _hoisted_32 = {
...
function _sfc_render(_ctx, _cache) {
  ...
  return openBlock(), createElementBlock("div", null, [
    _cache[219] || (_cache[219] = createBaseVNode(
      "h1",
      {
        id: "project-work",
        tabindex: "-1"
    ...
    _cache[220] || (_cache[220] = createBaseVNode(
      ...
      null,
      [
        createTextVNode("On this page you find information about the examination test "),
    ...
    _cache[221] || (_cache[221] = createBaseVNode(
      "h2",
      {
    ...
    createBaseVNode("ul", null, [
      createBaseVNode("li", null, [
        ...
        _cache[6] || (_cache[6] = createTextVNode(" A program used for containerization, i.e. a program used for running other programs in an isolated and configurable environment"))
      ])
    ]),
    _cache[224] || (_cache[224] = createBaseVNode(
      ...
      [
        createBaseVNode("p", { class: "custom-container-title" }, "Docker Toolbox for Windows"),
        createBaseVNode("p", null, [
          createTextVNode("There existed an old version of Docker for Windows called "),
          createBaseVNode("em", null, "Docker Toolbox"),
          createTextVNode(". It shouldn't be used anymore, so Windows users, be sure to use "),
          createBaseVNode("em", null, "Docker Desktop for Windows"),
          createTextVNode(".")
        ])
      ],
      -1
    ...
    _cache[225] || (_cache[225] = createBaseVNode(
      ...
      [
        createBaseVNode("p", { class: "custom-container-title" }, "About Docker Desktop for Windows"),
        createBaseVNode("p", null, [
          createTextVNode("Docker Desktop for Windows can be used with either "),
          createBaseVNode("em", null, "Windows Subsystems for Linux 2"),
          createTextVNode(" (WSL2) or Hyper-v. If you have Windows 10 Home (as most users), you must use it with WSL2. For more details, see the installation instructions on Docker's website.")
        ])
      ],
      -1
      /* HOISTED */
    ...
    createBaseVNode("ul", null, [
      createBaseVNode("li", null, [
        createBaseVNode("a", _hoisted_2, [
          _cache[7] || (_cache[7] = createTextVNode("Node.js")),
          createVNode(_component_ExternalLinkIcon)
        ]),
        ...
        _cache[10] || (_cache[10] = createTextVNode(" Use whichever version you want, but most likely the newer the better. If you don't want to gamble, go with the latest LTS version"))
      ]),
      createBaseVNode("li", null, [
        createBaseVNode("a", _hoisted_3, [
          _cache[11] || (_cache[11] = createTextVNode("npm")),
          createVNode(_component_ExternalLinkIcon)
        ]),
        ...
        _cache[15] || (_cache[15] = createTextVNode(" This one is installed along with Node.js, so you do not need to install it separately. However, you might want to ")),
        createBaseVNode("a", _hoisted_4, [
          _cache[12] || (_cache[12] = createTextVNode("update npm to the latest version")),
          createVNode(_component_ExternalLinkIcon)
        ])
      ]),
      createBaseVNode("li", null, [
        createBaseVNode("a", _hoisted_5, [
          _cache[16] || (_cache[16] = createTextVNode("Postman")),
          createVNode(_component_ExternalLinkIcon)
        ]),
        ...
        _cache[19] || (_cache[19] = createTextVNode(" An application one can use to send custom HTTP requests"))
      ])
    ]),
    ...
    createBaseVNode("ul", null, [
      createBaseVNode("li", null, [
        createBaseVNode("a", _hoisted_6, [
          _cache[20] || (_cache[20] = createTextVNode("Visual Studio Code")),
          createVNode(_component_ExternalLinkIcon)
        ]),
        ...
        _cache[23] || (_cache[23] = createTextVNode(" IDE with good support for writing, running and debugging Node.js and JavaScript code, but feel free to use whichever IDE you want"))
      ]),
      createBaseVNode("li", null, [
        createBaseVNode("a", _hoisted_7, [
          _cache[24] || (_cache[24] = createTextVNode("Git")),
          createVNode(_component_ExternalLinkIcon)
        ]),
        ...
        _cache[27] || (_cache[27] = createTextVNode(" Version Control System that makes it very convenient to work on the project from different computers"))
      ])
    ]),
    _cache[227] || (_cache[227] = createBaseVNode(
      ...
      [
        ...
        createTextVNode(" Part 1: Project group")
      ],
      -1
      /* HOISTED */
    )),
    createBaseVNode("p", null, [
      _cache[29] || (_cache[29] = createTextVNode("The project work should be carried out in pairs. Let the examiner know who you are working with by joining one of the ")),
      createBaseVNode("a", _hoisted_8, [
        _cache[28] || (_cache[28] = createTextVNode("Project Groups")),
        createVNode(_component_ExternalLinkIcon)
      ]),
      _cache[30] || (_cache[30] = createTextVNode(" on Canvas."))
    ]),
    createBaseVNode("p", null, [
      _cache[31] || (_cache[31] = createTextVNode("If you can't find someone to work with, send the course coordinator an email at ")),
      ...
      _cache[33] || (_cache[33] = createTextVNode(" using the template in ")),
      createVNode(_component_FigureNumber),
      _cache[34] || (_cache[34] = createTextVNode(" below (you just need to replace ")),
      ...
      _cache[36] || (_cache[36] = createTextVNode(" with your own specific values)."))
    ]),
    ...
    _cache[229] || (_cache[229] = createBaseVNode(
      ...
      [
        ...
        createTextVNode(" Part 2: Project environment")
      ],
      -1
      /* HOISTED */
    )),
    ...
    createBaseVNode("ul", null, [
      createBaseVNode("li", null, [
        _cache[39] || (_cache[39] = createTextVNode("Read/View the following lectures: ")),
        createBaseVNode("ul", null, [
          createBaseVNode("li", null, [
      ...
      createBaseVNode("li", null, [
        _cache[41] || (_cache[41] = createTextVNode("Read the following short course on Git: ")),
        createBaseVNode("ul", null, [
          createBaseVNode("li", null, [
    ...
    createBaseVNode("p", null, [
      _cache[43] || (_cache[43] = createTextVNode("We recommend you to work together per the basis described in the ")),
      createVNode(_component_RouterLink, { to: "/lectures/teamwork/" }, {
      ...
      _cache[44] || (_cache[44] = createTextVNode(" lecture. That way you will automatically document who has contributed with what by using Git and GitHub issues. But if you want to work together in another way, that is OK too as long as you can show who has contributed with what in the project. The ")),
      ...
      _cache[46] || (_cache[46] = createTextVNode(" chapter in ")),
      ...
      _cache[48] || (_cache[48] = createTextVNode(" shows an example of how you can report who has contributed with what in the project."))
    ]),
    createBaseVNode("p", null, [
      ...
      createBaseVNode("a", _hoisted_9, [
        _cache[49] || (_cache[49] = createTextVNode("GitHub")),
        createVNode(_component_ExternalLinkIcon)
      ]),
      _cache[51] || (_cache[51] = createTextVNode(", and then clone it to your own computers"))
    ]),
    _cache[233] || (_cache[233] = createBaseVNode(
      ...
      [
        ...
        createTextVNode(" Part 3: Platform idea")
      ],
      -1
      /* HOISTED */
    )),
    ...
    createBaseVNode("ul", null, [
      createBaseVNode("li", null, [
        _cache[54] || (_cache[54] = createTextVNode("Read/View the following lectures: ")),
        createBaseVNode("ul", null, [
          createBaseVNode("li", null, [
    ...
    createBaseVNode("ul", null, [
      createBaseVNode("li", null, [
        _cache[61] || (_cache[61] = createTextVNode("Read/View the following lectures: ")),
        createBaseVNode("ul", null, [
          createBaseVNode("li", null, [
            ...
            _cache[59] || (_cache[59] = createTextVNode(" (use another frontend framework if you want)"))
          ]),
          createBaseVNode("li", null, [
    ...
    createBaseVNode("ol", null, [
      ...
      createBaseVNode("li", null, [
        _cache[67] || (_cache[67] = createTextVNode("Open ")),
        createBaseVNode("a", _hoisted_14, [
          _cache[66] || (_cache[66] = createTextVNode("127.0.0.1:5173")),
          createVNode(_component_ExternalLinkIcon)
        ]),
        _cache[68] || (_cache[68] = createTextVNode(" (or whichever port number you end up using) in a web browser to run the frontend application"))
      ]),
    ...
    createBaseVNode("p", null, [
      _cache[72] || (_cache[72] = createTextVNode("Implement the layout of your frontend application in the ")),
      ...
      _cache[74] || (_cache[74] = createTextVNode(" file. The main content on the different pages can be implemented in their own ")),
    ...
    _cache[244] || (_cache[244] = createBaseVNode(
      ...
      [
        ...
        createTextVNode(" Part 7: Database")
      ],
      -1
      /* HOISTED */
    )),
    ...
    createBaseVNode("ul", null, [
      createBaseVNode("li", null, [
        _cache[84] || (_cache[84] = createTextVNode("Read/View the following lectures: ")),
        createBaseVNode("ul", null, [
          createBaseVNode("li", null, [
    ...
    createBaseVNode("p", null, [
      _cache[85] || (_cache[85] = createTextVNode("In this part, the goal is to use Docker and Docker Compose to get your database up and running in a container you can connect to from your own computer, as shown in ")),
      createVNode(_component_FigureNumber),
      _cache[86] || (_cache[86] = createTextVNode(" below."))
    ]),
    ...
    createBaseVNode("div", _hoisted_17, [
      ...
      createBaseVNode("p", null, [
        _cache[87] || (_cache[87] = createTextVNode("If you use Linux as the operating system on your computer, then you will only have one Linux installation on your computer, as shown in ")),
        createVNode(_component_FigureNumber),
        _cache[88] || (_cache[88] = createTextVNode(" below instead."))
      ]),
    ...
    _cache[247] || (_cache[247] = createBaseVNode(
      ...
      [
        ...
        createTextVNode(" Creating Docker image")
      ],
      -1
      /* HOISTED */
    )),
    _cache[248] || (_cache[248] = createBaseVNode(
      ...
      null,
      [
        createTextVNode("In your project folder, create a new folder that will store the code required to run all the applications your solution consists of (database, backend and frontend). We will refer to this folder as the "),
        createBaseVNode("code", null, "applications"),
    ...
    createBaseVNode("div", _hoisted_18, [
      ...
      createBaseVNode("p", null, [
        _cache[90] || (_cache[90] = createTextVNode("When using Docker on Windows, the recommendation is to use Windows Subsystem for Linux 2, and place your project folder on the file system for the Linux distribution you are using. If you work on your private computer (i.e. uses Window 10 Home), do that, as shown in ")),
        createVNode(_component_FigureNumber),
        _cache[91] || (_cache[91] = createTextVNode(" below. Otherwise automatic restart of applications when you save code changes made to files might not work (learn more about that later)."))
      ]),
      ...
      createBaseVNode("p", null, [
        _cache[92] || (_cache[92] = createTextVNode("On the school's computers (that uses Windows 10 Education), Docker runs on Hyper-V instead of Windows Subsystem for Linux 2, so on the school's computers you should place your project folder directly on the file system on Windows instead, as shown in ")),
        createVNode(_component_FigureNumber),
      ...
      createBaseVNode("p", null, [
        _cache[95] || (_cache[95] = createTextVNode("For detailed information, read ")),
        createBaseVNode("a", _hoisted_19, [
          _cache[94] || (_cache[94] = createTextVNode("Docker Best Practices")),
          createVNode(_component_ExternalLinkIcon)
        ]),
    ...
    _cache[249] || (_cache[249] = createBaseVNode(
      ...
      [
        ...
        createBaseVNode("code", null, "applications"),
        createTextVNode(" folder, create a folder that will store all the code required to run the database. We will refer to this folder as the "),
        createBaseVNode("code", null, "database"),
        createTextVNode(" folder.")
      ],
      -1
      /* HOISTED */
    ...
    createBaseVNode("p", null, [
      _cache[101] || (_cache[101] = createTextVNode("In the ")),
      ...
      _cache[103] || (_cache[103] = createTextVNode(" folder, create a new file named ")),
      ...
      _cache[105] || (_cache[105] = createTextVNode(" that specifies which database to run. Use whichever type of ")),
      ...
      _cache[107] || (_cache[107] = createTextVNode(" you want (MariaDB, MySQL, MariaDB, etc.). On ")),
      createBaseVNode("a", _hoisted_20, [
        _cache[99] || (_cache[99] = createTextVNode("Docker Hub")),
        createVNode(_component_ExternalLinkIcon)
      ]),
      _cache[108] || (_cache[108] = createTextVNode(", find an image that contains the database you want to use, and then inherit from that one in your own ")),
    ...
    createBaseVNode("p", null, [
      ...
      createBaseVNode("a", _hoisted_22, [
        _cache[112] || (_cache[112] = createTextVNode("Docker port mapping")),
        createVNode(_component_ExternalLinkIcon)
      ]),
      _cache[114] || (_cache[114] = createTextVNode(", as shown in ")),
      createVNode(_component_FigureNumber),
    ...
    createBaseVNode("div", _hoisted_23, [
      ...
      _cache[120] || (_cache[120] = createBaseVNode(
        ...
        null,
        [
          createTextVNode("Another solution is to run the following command before you run the "),
          createBaseVNode("code", null, "docker compose up"),
      ...
      _cache[121] || (_cache[121] = createBaseVNode(
        ...
        [
          createBaseVNode("pre", { class: "language-text" }, [
            createBaseVNode("code", null, "docker compose down\n")
          ]),
          createBaseVNode("div", {
            class: "line-numbers",
            "aria-hidden": "true"
    ...
    _cache[252] || (_cache[252] = createBaseVNode(
      ...
      null,
      [
        createTextVNode("It can also be a good idea to, in a similar way, create an "),
        createBaseVNode("code", null, "insert-data.sql"),
        createTextVNode(" file that populates the tables with some initial data when the database starts (used during development; does not make sense to do when the platform runs for real).")
      ],
      -1
      /* HOISTED */
    )),
    ...
    _cache[254] || (_cache[254] = createBaseVNode(
      ...
      [
        ...
        createTextVNode(" Part 8: Backend")
      ],
      -1
      /* HOISTED */
    )),
    ...
    createBaseVNode("ul", null, [
      createBaseVNode("li", null, [
        _cache[126] || (_cache[126] = createTextVNode("Read/View the following lectures: ")),
        createBaseVNode("ul", null, [
          createBaseVNode("li", null, [
    ...
    createBaseVNode("p", null, [
      _cache[127] || (_cache[127] = createTextVNode("In this part, the goal is to use Docker and Docker Compose to get your backend up and running in a container, and to connect it to the database, as shown in ")),
      createVNode(_component_FigureNumber),
      _cache[128] || (_cache[128] = createTextVNode(" below."))
    ]),
    ...
    createBaseVNode("p", null, [
      _cache[129] || (_cache[129] = createTextVNode("But to get a gentler start, we will first get the backend running on the computer without Docker, as shown in ")),
      createVNode(_component_FigureNumber),
      _cache[130] || (_cache[130] = createTextVNode(" below."))
    ]),
    createVNode(_component_Figure, { caption: "Architecture." }, {
      default: withCtx(() => [
        createVNode(_component_RenderMermaid, { "graph-definition": "\nflowchart\n	db[DB]\n	backend[Backend]\n	pm[Postman]\n	pf[Project Folder]\n	subgraph Your Computer\n		subgraph Your OS\n			pm\n			backend\n		end\n		subgraph Linux\n			subgraph Container 1\n				db\n			end\n		pf\n		end\n	end\n	pm--HTTP-->backend\n	backend--SQL-->db\n" })
    ...
    _cache[257] || (_cache[257] = createBaseVNode(
      ...
      [
        ...
        createTextVNode(" A basic implementation")
      ],
      -1
      /* HOISTED */
    )),
    _cache[258] || (_cache[258] = createBaseVNode(
      ...
      null,
      [
        createTextVNode("Create a new folder where you can store the source code for your backend application. To start with, you can store it on the file system for your ordinary operating system. We will refer to this folder as the "),
        createBaseVNode("code", null, "backend"),
        createTextVNode(" folder.")
      ],
      -1
      /* HOISTED */
    ...
    _cache[259] || (_cache[259] = createBaseVNode(
      ...
      [
        ...
        createBaseVNode("code", null, "backend"),
        createTextVNode(" folder in a shell, and then run the following commands (you don't have to use Express, but if you use another framework, the teacher at the lab sessions might not be able to help you):")
      ],
      -1
      /* HOISTED */
    )),
    createBaseVNode("ol", null, [
      _cache[135] || (_cache[135] = createBaseVNode(
        ...
        null,
        [
          createBaseVNode("code", null, "npm init --yes")
        ],
        -1
        /* HOISTED */
      )),
      _cache[136] || (_cache[136] = createBaseVNode(
        ...
        null,
        [
          createBaseVNode("code", null, "npm install express")
        ],
        -1
        /* HOISTED */
      )),
    ...
    createBaseVNode("p", null, [
      ...
      _cache[141] || (_cache[141] = createTextVNode(" folder to the ")),
      ...
      _cache[143] || (_cache[143] = createTextVNode(" folder. Then, in the ")),
      ...
      _cache[145] || (_cache[145] = createTextVNode(" folder, create the ")),
      ...
      _cache[147] || (_cache[147] = createTextVNode(", and inherit from an image on Docker Hub that contains the things you need to run your code. To learn which instructions you need to write in the ")),
    ...
    createBaseVNode("p", null, [
      ...
      _cache[153] || (_cache[153] = createTextVNode(" as the ")),
      ...
      _cache[155] || (_cache[155] = createTextVNode(" connection parameter to the database to indicate that it should connect to the database container. To be able to connect to the backend from your web browser you still need to use port mapping, for example map port ")),
      ...
      _cache[157] || (_cache[157] = createTextVNode(" on your computer to port ")),
      _cache[158] || (_cache[158] = createBaseVNode(
        "code",
        null,
        "8080",
        -1
      ...
      _cache[159] || (_cache[159] = createTextVNode(" in the backend container, as shown in ")),
      createVNode(_component_FigureNumber),
      _cache[160] || (_cache[160] = createTextVNode(" below, since the computer running your OS is not part of the virtual network."))
    ]),
    createVNode(_component_Figure, { caption: "Architecture." }, {
      default: withCtx(() => [
    ...
    createBaseVNode("p", null, [
      ...
      _cache[167] || (_cache[167] = createTextVNode(" folder, Node.js in the container needs to restart your application to pick up the changes. To make that happen, we can use the ")),
      createBaseVNode("a", _hoisted_28, [
        _cache[164] || (_cache[164] = createTextVNode("Watch mode")),
        createVNode(_component_ExternalLinkIcon)
      ]),
      _cache[168] || (_cache[168] = createTextVNode(" feature that was added to Node.js in version ")),
      _cache[169] || (_cache[169] = createBaseVNode(
        "code",
        null,
        "18.11.0",
        -1
      ...
      _cache[170] || (_cache[170] = createTextVNode(". In your ")),
      _cache[171] || (_cache[171] = createBaseVNode(
        "code",
        null,
        "Dockerfile",
        -1
      ...
      _cache[172] || (_cache[172] = createTextVNode(", add the ")),
      ...
      _cache[174] || (_cache[174] = createTextVNode(" flag to the command used to start your backend application (i.e. use ")),
    ...
    createBaseVNode("p", null, [
      _cache[184] || (_cache[184] = createTextVNode("In this part, the goal is to use Docker and Docker Compose to get your frontend up and running in a container, and then allow the Web Browser to retrieve your SPA from it, and then allow the SPA in the Web Browser to connect to the backend, as shown in ")),
      createVNode(_component_FigureNumber),
      _cache[185] || (_cache[185] = createTextVNode(" below."))
    ]),
    createVNode(_component_Figure, { caption: "Architecture." }, {
      default: withCtx(() => [
    ...
    _cache[267] || (_cache[267] = createBaseVNode(
      ...
      [
        ...
        createTextVNode(" Communicating with the backend")
      ],
      -1
      /* HOISTED */
    )),
    ...
    _cache[270] || (_cache[270] = createBaseVNode(
      "h2",
      {
        id: "part-10-auth",
        tabindex: "-1"
    ...
    createBaseVNode("ul", null, [
      createBaseVNode("li", null, [
        _cache[196] || (_cache[196] = createTextVNode("Read/View the following lectures: ")),
        createBaseVNode("ul", null, [
          createBaseVNode("li", null, [
    ...
    _cache[272] || (_cache[272] = createBaseVNode(
      "hr",
      null,
      null,
      -1
    ...
    _cache[273] || (_cache[273] = createBaseVNode(
      "p",
      null,
      [
        createTextVNode("Add authentication and authorization to your backend through the use of Access Tokens (implemented as JWT) and ID Tokens per the OAuth 2.0 and OpenID Connect specifications. You only need to support the "),
        createBaseVNode("em", null, "Resource Owner Password Credentials Grant"),
        createTextVNode(".")
      ],
      -1
      /* HOISTED */
    ...
    _cache[276] || (_cache[276] = createBaseVNode(
      ...
      [
        ...
        createTextVNode(" Part 11: Grade 4 and 5")
      ],
      -1
      /* HOISTED */
    )),
    createBaseVNode("p", null, [
      _cache[198] || (_cache[198] = createTextVNode("Be sure to read through ")),
      createVNode(_component_RouterLink, { to: "/courses/web-development-advanced-concepts/project-grading-guidelines/" }, {
      ...
      _cache[199] || (_cache[199] = createTextVNode(" to see that you follow the guidelines for the grade you're aiming for. To be able get grade 4 and 5 you also need to implement the extra functionality described next. Make sure to also describe in the report how you have implemented them."))
    ]),
    _cache[277] || (_cache[277] = createBaseVNode(
      ...
      [
        ...
        createTextVNode(" SDK (required for grade 4 and 5)")
      ],
      -1
      /* HOISTED */
    )),
    ...
    _cache[279] || (_cache[279] = createBaseVNode(
      ...
      [
        ...
        createTextVNode(" Supporting Multiple Data Formats (required for grade 4 and 5)")
      ],
      -1
      /* HOISTED */
    )),
    createBaseVNode("p", null, [
      _cache[201] || (_cache[201] = createTextVNode("Add support for another data format in addition to JSON in your REST API and backend. This should work in both requests and responses, so when you receive a request you need to look at the ")),
      ...
      _cache[203] || (_cache[203] = createTextVNode(" header to figure out which format the body in the request is written in, and you also need to look at the ")),
      ...
      _cache[205] || (_cache[205] = createTextVNode(" header to figure out in which format you should send back the body in the response in (this is known as ")),
      createBaseVNode("a", _hoisted_33, [
        _cache[200] || (_cache[200] = createTextVNode("Content Negotiation")),
        createVNode(_component_ExternalLinkIcon)
      ]),
    ...
    _cache[281] || (_cache[281] = createBaseVNode(
      ...
      null,
      [
        createBaseVNode("li", null, "XML"),
        createBaseVNode("li", null, "YAML")
      ],
      -1
      /* HOISTED */
    )),
    createBaseVNode("p", null, [
      _cache[208] || (_cache[208] = createTextVNode("Try to ")),
      createBaseVNode("a", _hoisted_34, [
        _cache[207] || (_cache[207] = createTextVNode("find a suitable npm package")),
        createVNode(_component_ExternalLinkIcon)
      ]),
      _cache[209] || (_cache[209] = createTextVNode(" doing most of the work for you."))
    ]),
    ...
    createBaseVNode("p", null, [
      _cache[211] || (_cache[211] = createTextVNode("Join one of the ")),
      createBaseVNode("a", _hoisted_35, [
        _cache[210] || (_cache[210] = createTextVNode("Project Demonstration Groups")),
        createVNode(_component_ExternalLinkIcon)
      ]),
      _cache[212] || (_cache[212] = createTextVNode(" on Canvas (first come, first served). Only one in each Project Group should join the Project Demonstration Group you want to join. Which group you join determines when you should demonstrate your work. You will only demonstrate your solution to the other within the same group."))
    ]),
    ...
    createBaseVNode("p", null, [
      _cache[214] || (_cache[214] = createTextVNode("After your demonstration, the teacher there will approve you on the Canvas assignment ")),
      createBaseVNode("a", _hoisted_36, [
        _cache[213] || (_cache[213] = createTextVNode("Project Demonstration")),
        createVNode(_component_ExternalLinkIcon)
      ]),
    ...
    _cache[284] || (_cache[284] = createBaseVNode(
      ...
      [
        ...
        createTextVNode(" Part 13: Final submission")
      ],
      -1
      /* HOISTED */
    )),
    createBaseVNode("p", null, [
      _cache[217] || (_cache[217] = createTextVNode("When you're done with your work, upload it to Canvas by submitting the assignment ")),
      createBaseVNode("a", _hoisted_37, [
        _cache[216] || (_cache[216] = createTextVNode("Project Submission")),
        createVNode(_component_ExternalLinkIcon)
      ]),
      _cache[218] || (_cache[218] = createTextVNode(". Be sure to follow the submission instructions described on that page."))
    ])
  ]);
}
