...
function _sfc_render(_ctx, _cache) {
  ...
  return openBlock(), createElementBlock("div", null, [
    ...
    _cache[39] || (_cache[39] = createBaseVNode(
      ...
      null,
      [
        createTextVNode("You have probably heard about and used "),
        createBaseVNode("em", null, "the Internet"),
        createTextVNode(", but what is it really? And how does it differ from "),
        createBaseVNode("em", null, "the web"),
        createTextVNode("? In this lecture you'll be introduced to what the Internet is and how the basics work.")
      ],
      -1
      /* HOISTED */
    )),
    ...
    _cache[41] || (_cache[41] = createStaticVNode('<h2 id="lecture-material" tabindex="-1"><a class="header-anchor" href="#lecture-material" aria-hidden="true">#</a> Lecture material</h2><ul><li><a href="internet-basics.pdf">internet-basics.pdf</a></li><li><a href="internet-basics.pptx">internet-basics.pptx</a></li></ul><h2 id="recommended-reading" tabindex="-1"><a class="header-anchor" href="#recommended-reading" aria-hidden="true">#</a> Recommended reading</h2>', 3)),
    createBaseVNode("ul", null, [
      createBaseVNode("li", null, [
        _cache[4] || (_cache[4] = createTextVNode("The following Wikipedia articles gives a good overview of the Internet: ")),
        createBaseVNode("ul", null, [
          createBaseVNode("li", null, [
            createBaseVNode("a", _hoisted_1, [
              _cache[0] || (_cache[0] = createTextVNode("Internet")),
              createVNode(_component_ExternalLinkIcon)
            ])
          ]),
          createBaseVNode("li", null, [
            createBaseVNode("a", _hoisted_2, [
              _cache[1] || (_cache[1] = createTextVNode("History of the Internet")),
              createVNode(_component_ExternalLinkIcon)
            ])
          ]),
          createBaseVNode("li", null, [
            createBaseVNode("a", _hoisted_3, [
              _cache[2] || (_cache[2] = createTextVNode("Internet Protocol")),
              createVNode(_component_ExternalLinkIcon)
            ])
          ]),
          createBaseVNode("li", null, [
            createBaseVNode("a", _hoisted_4, [
              _cache[3] || (_cache[3] = createTextVNode("IPv6 deployment")),
              createVNode(_component_ExternalLinkIcon)
            ])
          ])
        ])
      ...
      createBaseVNode("li", null, [
        createBaseVNode("a", _hoisted_5, [
          _cache[5] || (_cache[5] = createTextVNode("submarinecablemap.com")),
          createVNode(_component_ExternalLinkIcon)
        ])
      ]),
      createBaseVNode("li", null, [
        createBaseVNode("a", _hoisted_6, [
          _cache[6] || (_cache[6] = createTextVNode("Internet Protocol Specification")),
          createVNode(_component_ExternalLinkIcon)
        ]),
        _cache[7] || (_cache[7] = createBaseVNode(
          ...
          null,
          [
            createBaseVNode("li", null, "Probably not that interesting nor relevant for you to read, but do be aware of its existence.")
          ],
          -1
          /* HOISTED */
        ))
    ...
    createBaseVNode("p", null, [
      ...
      _cache[16] || (_cache[16] = createTextVNode(", where each letter is a number between 0 and 65536. Each such number can be implemented using 64 bits, so each number is usually written as 4 ")),
      createBaseVNode("a", _hoisted_8, [
        _cache[13] || (_cache[13] = createTextVNode("hexadecimal digits")),
        createVNode(_component_ExternalLinkIcon)
      ]),
      _cache[17] || (_cache[17] = createTextVNode(", for example ")),
      ...
      _cache[19] || (_cache[19] = createTextVNode(". A complete IP version 6 IP address can look like ")),
    ...
    createBaseVNode("p", null, [
      ...
      _cache[30] || (_cache[30] = createTextVNode(") service that runs on the Internet. It consists of many computers on the Internet hosting websites (called servers), and when your web browser communicates with one of them, it will do so using the ")),
      createBaseVNode("a", _hoisted_11, [
        _cache[27] || (_cache[27] = createTextVNode("HyperText Transfer Protocol")),
        createVNode(_component_ExternalLinkIcon)
      ]),
      _cache[31] || (_cache[31] = createTextVNode(" (HTTP). HTTP usually runs on top of TCP and uses port 80."))
    ]),
    ...
    createBaseVNode("p", null, [
      _cache[33] || (_cache[33] = createTextVNode("When your computer sends an email on the Internet it uses a protocol called the ")),
      createBaseVNode("a", _hoisted_12, [
        _cache[32] || (_cache[32] = createTextVNode("Simple Mail Transfer Protocol")),
        createVNode(_component_ExternalLinkIcon)
      ]),
      _cache[34] || (_cache[34] = createTextVNode(" (SMTP). SMTP usually runs on top of TCP and uses port 25."))
    ]),
    _cache[49] || (_cache[49] = createBaseVNode(
      ...
      [
        ...
        createTextVNode(" File sharing")
      ],
      -1
      /* HOISTED */
    )),
    createBaseVNode("p", null, [
      _cache[36] || (_cache[36] = createTextVNode("Not as common as before we got the web, but there exists computers on the Internet storing files. these are known as file servers. When other computers want to download the files from them, they use the protocol called the ")),
      createBaseVNode("a", _hoisted_13, [
        _cache[35] || (_cache[35] = createTextVNode("File Transfer Protocol")),
        createVNode(_component_ExternalLinkIcon)
      ]),
      _cache[37] || (_cache[37] = createTextVNode(" (FTP). FTP usually runs on top of TCP and uses port 20 and 21."))
    ]),
