...
function resolveCssVars(instance, vnode, expectedMap) {
  ...
  if (instance.getCssVars && (vnode === root || root && root.type === Fragment && root.children.includes(vnode))) {
    const cssVars2 = instance.getCssVars();
    for (const key in cssVars2) {
      expectedMap.set(
...
const themeData$1 = JSON.parse(`{"docsDir":"src","docsRepo":"https://github.com/pr-ju/course-material","docsBranch":"master","editLink":true,"editLinkText":"Improve this page!","lastUpdatedText":"Last Updated","navbar":[{"text":"Home","link":"/"},{"text":"Courses","children":[{"text":"Introduction to Script Programming","link":"/courses/introduction-to-script-programming/"}]},{"text":"Get Help","link":"https://github.com/pr-ju/course-material/issues"}],"contributors":false,"sidebarDepth":2,"sidebar":{"/courses/android-development/":[{"text":"Android Development 2023"},"index.html"],"/courses/client-server-communication/":[{"text":"Client-Server Communication 2022"},"index.html"],"/courses/git/":[{"text":"Git"},"index.html"],"/courses/introduction-to-script-programming/":[{"text":"Introduction to Script Programming"},"index.html","study-guide","lectures","exercises","laboratory-work","written-examination","course-syllabus"],"/courses/object-oriented-software-development/":[{"text":"Object-oriented Software Development 2020"},"lab-1-example"],"/courses/web-development-advanced-concepts/":[{"text":"Web Development - Advanced Concepts 2023"},"index.html"],"/courses/web-development-fundamentals/":[{"text":"Web Development Fundamentals 2022"},"index.html"],"/":[""]},"locales":{"/":{"selectLanguageName":"English"}},"colorMode":"auto","colorModeSwitch":true,"logo":null,"repo":null,"selectLanguageText":"Languages","selectLanguageAriaLabel":"Select language","lastUpdated":true,"contributorsText":"Contributors","notFound":["There's nothing here.","How did we get here?","That's a Four-Oh-Four.","Looks like we've got some broken links."],"backToHome":"Take me home","openInNewWindow":"open in new window","toggleColorMode":"toggle color mode","toggleSidebar":"toggle sidebar"}`);
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("header", _hoisted_1$c, [
        ...
        actions.value.length ? (openBlock(), createElementBlock("p", _hoisted_4$3, [
          (openBlock(true), createElementBlock(
            Fragment,
            null,
...
const _hoisted_5$1 = { class: "navbar-dropdown" };
const _hoisted_6$1 = { class: "navbar-dropdown-subtitle" };
const _hoisted_7$1 = { key: 1 };
const _hoisted_8$1 = { class: "navbar-dropdown-subitem-wrapper" };
                    ...
                    renderList(unref(item).children, (child) => {
                      return openBlock(), createElementBlock("li", {
                        ...
                        child.children ? (openBlock(), createElementBlock(
                          ...
                          { key: 0 },
                          [
                            createBaseVNode("h4", _hoisted_6$1, [
    ...
    return (_ctx, _cache) => {
      return prevNavLink.value || nextNavLink.value ? (openBlock(), createElementBlock("nav", _hoisted_1$5, [
        createBaseVNode("p", _hoisted_2$2, [
          ...
          nextNavLink.value ? (openBlock(), createElementBlock("span", _hoisted_4, [
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("li", null, [
        unref(item).link ? (openBlock(), createBlock(AutoLink, {
          ...
          item: unref(item)
        }, null, 8, ["class", "item"])) : (openBlock(), createElementBlock(
          "p",
          {
            key: 1,
            tabindex: "0",
...
const clientConfig7 = {
  enhance: ({ app }) => {
    app.component("AcademicYearFigure", defineAsyncComponent(() => __vitePreload(() => import("./AcademicYearFigure-dbedcd41.js"), true ? [] : void 0))), app.component("CompactInfo", defineAsyncComponent(() => __vitePreload(() => import("./CompactInfo-3e9df8d1.js"), true ? [] : void 0))), app.component("ExamQuestion", defineAsyncComponent(() => __vitePreload(() => import("./ExamQuestion-5f91bf90.js"), true ? [] : void 0))), app.component("Figure", defineAsyncComponent(() => __vitePreload(() => import("./Figure-ece70ca5.js"), true ? [] : void 0))), app.component("FigureNumber", defineAsyncComponent(() => __vitePreload(() => import("./FigureNumber-38d5b1c8.js"), true ? [] : void 0))), app.component("GradingGuideline", defineAsyncComponent(() => __vitePreload(() => import("./GradingGuideline-0d490b59.js"), true ? [] : void 0))), app.component("ILOsActivitiesMapping", defineAsyncComponent(() => __vitePreload(() => import("./ILOsActivitiesMapping-77d49b5c.js"), true ? [] : void 0))), app.component("RenderMermaid", defineAsyncComponent(() => __vitePreload(() => import("./RenderMermaid-b3facaaa.js"), true ? [] : void 0))), app.component("ReportMistake", defineAsyncComponent(() => __vitePreload(() => import("./ReportMistake-d87666f3.js"), true ? [] : void 0))), app.component("SampleAnswer", defineAsyncComponent(() => __vitePreload(() => import("./SampleAnswer-9abedf44.js"), true ? [] : void 0))), app.component("SleepButton", defineAsyncComponent(() => __vitePreload(() => import("./SleepButton-f3fecd79.js"), true ? [] : void 0))), app.component("Smartphone", defineAsyncComponent(() => __vitePreload(() => import("./Smartphone-0dd9a2ef.js"), true ? [] : void 0))), app.component("StudyGuideInfo", defineAsyncComponent(() => __vitePreload(() => import("./StudyGuideInfo-25616bbe.js"), true ? [] : void 0))), app.component("Teacher", defineAsyncComponent(() => __vitePreload(() => import("./Teacher-aa2d984e.js"), true ? [] : void 0))), app.component("TimePlan", defineAsyncComponent(() => __vitePreload(() => import("./TimePlan-81770b0a.js"), true ? [] : void 0)));
  }
};
const clientConfigs = [
  clientConfig0,
...
const pagesRoutes = [
  ...
  ["v-7e7ef5e7", "/courses/introduction-to-script-programming/exercises.html", { "title": "Self Study Exercises" }, ["/courses/introduction-to-script-programming/exercises", "/courses/introduction-to-script-programming/exercises.md"]],
  ...
  ["v-22e3845b", "/courses/introduction-to-script-programming/lectures.html", { "title": "Video Lectures" }, ["/courses/introduction-to-script-programming/lectures", "/courses/introduction-to-script-programming/lectures.md"]],
...
var createVueApp = async () => {
  ...
  {
    const { setupDevtools } = await __vitePreload(() => import("./setupDevtools-X4YFRK4B-469d4ccf.js"), true ? [] : void 0);
