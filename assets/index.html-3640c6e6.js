...
const _hoisted_5 = { class: "custom-container warning" };
const _hoisted_6 = {
...
function _sfc_render(_ctx, _cache) {
  ...
  return openBlock(), createElementBlock("div", null, [
    ...
    createBaseVNode("ul", null, [
      createBaseVNode("li", null, [
        ...
        _cache[1] || (_cache[1] = createBaseVNode(
          ...
          null,
          [
            createBaseVNode("li", null, "Notice that you find many of the big guys (Google, Microsoft, etc.) in the list.")
          ],
          -1
          /* HOISTED */
        ))
      ...
      createBaseVNode("li", null, [
        createBaseVNode("a", _hoisted_2, [
          _cache[2] || (_cache[2] = createTextVNode("OAuth 2.0 Framework - RFC 6749")),
          createVNode(_component_ExternalLinkIcon)
        ]),
        _cache[3] || (_cache[3] = createBaseVNode(
          ...
          null,
          [
            createBaseVNode("li", null, "You need to read this specification to learn the details of the framework, which you have to know when adding support for OAuth 2.0 in your own app, or when using another app supporting OAuth 2.0.")
          ],
          -1
          /* HOISTED */
        ))
      ...
      createBaseVNode("li", null, [
        createBaseVNode("a", _hoisted_3, [
          _cache[4] || (_cache[4] = createTextVNode("https://oauth.net/2/")),
          createVNode(_component_ExternalLinkIcon)
        ]),
        _cache[5] || (_cache[5] = createBaseVNode(
          ...
          null,
          [
            createBaseVNode("li", null, "If you think the specification is too hard to read to get the big picture, the resources on this website might be easier to understand.")
          ],
          -1
          /* HOISTED */
        ))
    ...
    createBaseVNode("p", null, [
      _cache[7] || (_cache[7] = createTextVNode("OAuth 2.0 describes 4 different flows clients can use to obtain an Access Token. With time, some of these flows have been found to contain security vulnerabilities and have been deprecated, and new and more secure flows have been created. ")),
      createBaseVNode("a", _hoisted_4, [
        _cache[6] || (_cache[6] = createTextVNode("OAuth 2.1")),
        createVNode(_component_ExternalLinkIcon)
      ]),
      _cache[8] || (_cache[8] = createTextVNode(" will contain the most up-to-date information about which flows that are best to use, but at the moment that's just a draft, and should not be seen as a reliable source of truth."))
    ]),
    _cache[28] || (_cache[28] = createBaseVNode(
      ...
      [
        ...
        createTextVNode(" Resource Owner Password Credentials Grant")
      ],
      -1
      /* HOISTED */
    )),
    ...
    _cache[30] || (_cache[30] = createBaseVNode(
      ...
      null,
      [
        createTextVNode("This flow does not require the Client to first register itself at the Authorization Server, so this flow does not make use of "),
        createBaseVNode("code", null, "client_id"),
        createTextVNode(" and "),
        createBaseVNode("code", null, "client_secret"),
        createTextVNode(". Also, no Authorization Grant is used, so the user directly obtains an Access Token from the Authorization Server.")
      ],
      -1
      /* HOISTED */
    )),
    createVNode(_component_FigureNumber),
    _cache[31] || (_cache[31] = createTextVNode(" below gives an overflow of the flow. For implementation details (which HTTP requests to send/responses to receive), check out the specification.")),
    ...
    _cache[33] || (_cache[33] = createBaseVNode(
      ...
      [
        createBaseVNode("p", { class: "custom-container-title" }, "This flow has been deprecated"),
    ...
    _cache[34] || (_cache[34] = createBaseVNode(
      ...
      [
        ...
        createTextVNode(" Authorization Code Grant")
      ],
      -1
      /* HOISTED */
    )),
    _cache[35] || (_cache[35] = createBaseVNode(
      ...
      null,
      [
        createTextVNode("This flow is the de-facto standard flow to use in OAuth 2.0. It is particularly used when the Client is a web application. The Authorization Grant used is in this flow is an "),
        createBaseVNode("em", null, "Authorization Code"),
        createTextVNode(".")
      ],
      -1
      /* HOISTED */
    ...
    createVNode(_component_FigureNumber),
    _cache[36] || (_cache[36] = createTextVNode(" below gives an overflow of the flow. For implementation details (which HTTP requests to send/responses to receive), check out the specification.")),
    ...
    createBaseVNode("div", _hoisted_5, [
      ...
      createBaseVNode("p", null, [
        _cache[10] || (_cache[10] = createTextVNode("This flow has been deprecated. The reasons are the security vulnerabilities explained in ")),
        createBaseVNode("a", _hoisted_6, [
          _cache[9] || (_cache[9] = createTextVNode("OAuth 2.0 Security Best Current Practice")),
          createVNode(_component_ExternalLinkIcon)
        ]),
        _cache[11] || (_cache[11] = createTextVNode(" for this flow."))
      ]),
    ...
    _cache[39] || (_cache[39] = createBaseVNode(
      ...
      [
        ...
        createTextVNode(" The Proof Key for Code Exchange extension")
      ],
      -1
      /* HOISTED */
    )),
    ...
    createBaseVNode("ol", null, [
      _cache[20] || (_cache[20] = createBaseVNode(
        ...
        null,
        [
          createTextVNode("Generates a random string called the "),
          createBaseVNode("code", null, "code_verifier")
        ],
        -1
        /* HOISTED */
      )),
      createBaseVNode("li", null, [
        _cache[15] || (_cache[15] = createTextVNode("Computes the ")),
        ...
        _cache[17] || (_cache[17] = createTextVNode(" by hashing the ")),
        ...
        _cache[19] || (_cache[19] = createTextVNode(" using ")),
        createBaseVNode("a", _hoisted_7, [
          _cache[14] || (_cache[14] = createTextVNode("SHA256")),
          createVNode(_component_ExternalLinkIcon)
        ])
      ])
    ]),
    _cache[44] || (_cache[44] = createBaseVNode(
      ...
      null,
      [
        createTextVNode("Then in the Resource Owner's request to the Authorization Server to generate an Authorization Code, it also passes along the "),
        createBaseVNode("code", null, "code_challenge"),
        createTextVNode(" to the Authorization Server, which the Authorization Server then remembers.")
      ],
      -1
      /* HOISTED */
    )),
    _cache[45] || (_cache[45] = createBaseVNode(
      ...
      null,
      [
        createTextVNode("Then, when the Client has obtained the Authorization Code and want's to exchange it for an Access Token, it also needs to pass along the "),
        createBaseVNode("code", null, "code_verifier"),
        createTextVNode(" in the request. The Authorization Server will hash the "),
        createBaseVNode("code", null, "code_verifier"),
        createTextVNode(" using SHA256, and if the hash value doesn't match the "),
        createBaseVNode("code", null, "code_challenge"),
        createTextVNode(" it received before, it won't accept the exchange. This way, only the true Client can exchange the Authorization Code for an Access Token, because no one else knows which valid "),
        createBaseVNode("code", null, "code_verifier"),
        createTextVNode(" to send to the Authorization Server in the exchange request.")
      ],
      -1
      /* HOISTED */
    )),
    createVNode(_component_FigureNumber),
    _cache[46] || (_cache[46] = createTextVNode(" below gives an overflow of the flow. For implementation details (which HTTP requests to send/responses to receive), check out the specifications.")),
    createVNode(_component_Figure, { caption: "The flow of the Authorization Code Grant." }, {
      default: withCtx(() => [
    ...
    _cache[47] || (_cache[47] = createBaseVNode(
      ...
      [
        ...
        createTextVNode(" Client Credentials Grant")
      ],
      -1
      /* HOISTED */
    )),
    _cache[48] || (_cache[48] = createBaseVNode(
      ...
      null,
      [
        createTextVNode("This flow can be used when the Client wants to obtain an Access Token it can use to access its own resources on the Resource Server (if you ever have a use-case for that). Since it uses "),
        createBaseVNode("code", null, "client_id"),
        createTextVNode(" and "),
        createBaseVNode("code", null, "client_secret"),
        createTextVNode(" you should only use this when the Client runs on a server, so your users won't have access to the source code and can read the "),
        createBaseVNode("code", null, "client_secret"),
        createTextVNode(".")
      ],
      -1
