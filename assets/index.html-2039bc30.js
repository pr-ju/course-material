    ...
    createBaseVNode("ul", null, [
      createBaseVNode("li", null, [
        createBaseVNode("a", _hoisted_1, [
          _cache[0] || (_cache[0] = createTextVNode("Handlebars' Language Guide")),
          createVNode(_component_ExternalLinkIcon)
        ])
      ]),
      createBaseVNode("li", null, [
        createBaseVNode("a", _hoisted_2, [
          _cache[1] || (_cache[1] = createTextVNode("tryhandlebarsjs.com")),
          createVNode(_component_ExternalLinkIcon)
        ]),
        _cache[2] || (_cache[2] = createBaseVNode(
          ...
          null,
          [
            createBaseVNode("li", null, "Use it for practice and to see a lot of examples.")
          ],
          -1
          /* HOISTED */
        ))
