...
function _sfc_render(_ctx, _cache) {
  ...
  return openBlock(), createElementBlock("div", null, [
    ...
    _cache[37] || (_cache[37] = createBaseVNode(
      ...
      null,
      [
        createTextVNode("When you work alone on a project with a Git repository, you usually don't need to worry that much about branches in Git. This is especially true when the repository only exists locally on your own computer, because then the repository only have a single branch (a default branch) called "),
        createBaseVNode("code", null, "master"),
        createTextVNode(" or "),
        createBaseVNode("code", null, "main"),
        createTextVNode(", and you can more or less ignore the fact that branches exist in Git, even though you do work on the "),
        createBaseVNode("code", null, "master"),
        createTextVNode("/"),
        createBaseVNode("code", null, "main"),
        createTextVNode(" branch all the time. But most often, this is not the case, and you need to have a basic understanding of how branches work in Git for you to use Git in best way possible. Furthermore, Linus Torvalds designed Git around the usage of branches, so they play a very central role in Git.")
      ],
      -1
      /* HOISTED */
    )),
    createBaseVNode("div", _hoisted_1, [
      ...
      createBaseVNode("p", null, [
        _cache[1] || (_cache[1] = createTextVNode("If you create your repository on your own computer using the ")),
        ...
        _cache[3] || (_cache[3] = createTextVNode(" command, then the default branch is called ")),
        ...
        _cache[5] || (_cache[5] = createTextVNode(". If you create your repository on a server, that you then clone to your own computer (read more about this in next lecture), then the default branch may have another name. For example, ")),
        createBaseVNode("a", _hoisted_2, [
          _cache[0] || (_cache[0] = createTextVNode("GitHub")),
          createVNode(_component_ExternalLinkIcon)
        ]),
        _cache[6] || (_cache[6] = createTextVNode(" names the default branch ")),
    ...
    createBaseVNode("p", null, [
      ...
      _cache[15] || (_cache[15] = createTextVNode("; just use ")),
      ...
      _cache[17] || (_cache[17] = createTextVNode(" directly to create a new commit, and then you can also use the commands ")),
      ...
      _cache[21] || (_cache[21] = createTextVNode(" and ")),
      ...
      _cache[23] || (_cache[23] = createTextVNode(" as expected (but you will never end up with merge conflicts, so you can't practice on resolving them using this tool)."))
    ]),
    createBaseVNode("p", null, [
      _cache[25] || (_cache[25] = createTextVNode("If you want some more practice, you can also try ")),
      createBaseVNode("a", _hoisted_4, [
        _cache[24] || (_cache[24] = createTextVNode("Learn Git Branching")),
        createVNode(_component_ExternalLinkIcon)
      ]),
    ...
    createBaseVNode("p", null, [
      _cache[28] || (_cache[28] = createTextVNode("If you want to learn more about branches in Git, read the following chapters from ")),
      createBaseVNode("a", _hoisted_5, [
        _cache[27] || (_cache[27] = createTextVNode("Pro Git")),
        createVNode(_component_ExternalLinkIcon)
      ]),
      _cache[29] || (_cache[29] = createTextVNode(" by ")),
      ...
      _cache[31] || (_cache[31] = createTextVNode(" and ")),
      ...
      _cache[33] || (_cache[33] = createTextVNode(" (available for free online in multiple different formats):"))
    ]),
    createBaseVNode("ul", null, [
      createBaseVNode("li", null, [
        createBaseVNode("a", _hoisted_6, [
          _cache[34] || (_cache[34] = createTextVNode("Chapter 3: Git Branching")),
          createVNode(_component_ExternalLinkIcon)
        ]),
