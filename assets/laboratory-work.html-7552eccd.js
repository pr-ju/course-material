...
const _imports_0 = "/course-material/assets/lab-1-lcc-formula-2b26b033.png";
const _imports_1 = "/course-material/assets/lab-1-present-value-factor-a416c4fb.png";
const _imports_2 = "/course-material/assets/lab-1-ids-6f31af43.png";
const _imports_3 = "/course-material/assets/lab-4-naming-model-2bfc4cad.png";
const _imports_4 = "/course-material/assets/lab-4-delivery-content-553189fb.png";
const _imports_5 = "/course-material/assets/lab-5-csv-in-excell-4e07d52a.png";
const _imports_6 = "/course-material/assets/lab-6-connect-four-empty-d37769af.png";
const _imports_7 = "/course-material/assets/lab-6-connect-four-with-moves-0d8fb2db.png";
const _imports_8 = "/course-material/assets/lab-6-construction-entity-06755a1f.png";
const _sfc_main = {};
const _hoisted_1 = {
  href: "https://co2kompensera.se/",
  target: "_blank",
  rel: "noopener noreferrer"
};
const _hoisted_2 = {
  href: "https://ju.instructure.com/courses/6982/assignments/38532",
  target: "_blank",
  rel: "noopener noreferrer"
};
const _hoisted_3 = {
  href: "https://ju.instructure.com/courses/6982/assignments/38533",
  target: "_blank",
  rel: "noopener noreferrer"
};
const _hoisted_4 = {
  href: "https://ju.instructure.com/courses/6982/assignments/38534",
  target: "_blank",
  rel: "noopener noreferrer"
};
const _hoisted_5 = {
  href: "https://ju.instructure.com/courses/6982/assignments/38535",
  target: "_blank",
  rel: "noopener noreferrer"
};
const _hoisted_6 = {
  href: "https://ju.instructure.com/courses/6982/assignments/38536",
  target: "_blank",
  rel: "noopener noreferrer"
};
const _hoisted_7 = {
...
const _hoisted_8 = {
  href: "https://ju.instructure.com/courses/6982/assignments/38537",
  target: "_blank",
  rel: "noopener noreferrer"
};
function _sfc_render(_ctx, _cache) {
  ...
  return openBlock(), createElementBlock("div", null, [
        ...
        createBaseVNode(
          ...
          [
            createBaseVNode("pre", { class: "language-text" }, [
              createBaseVNode("code", null, "This program displays a multiplication table.\nEnter the number for which the multiplication table should be shown: 5\n0 * 5 = 0\n1 * 5 = 5\n2 * 5 = 10\n3 * 5 = 15\n4 * 5 = 20\n5 * 5 = 25\n6 * 5 = 30\n7 * 5 = 35\n8 * 5 = 40\n9 * 5 = 45\n")
            ]),
            createBaseVNode("div", {
              class: "line-numbers",
              "aria-hidden": "true"
    ...
    _cache[128] || (_cache[128] = createBaseVNode(
      "h3",
      {
        id: "problem-1-5-displaying-a-more-complex-multiplication-table",
        tabindex: "-1"
      },
      [
        createBaseVNode("a", {
          class: "header-anchor",
          href: "#problem-1-5-displaying-a-more-complex-multiplication-table",
          "aria-hidden": "true"
        }, "#"),
        createTextVNode(" Problem 1.5: Displaying a more complex multiplication table")
      ],
      -1
      /* HOISTED */
    )),
    createBaseVNode("p", null, [
      _cache[3] || (_cache[3] = createTextVNode("Create a program that first asks the user to enter a number for which the multiplication table should be printed, and then asks the user to enter integers representing the lower bound and the upper bound of the multiplication table. It can look like as shown in ")),
      createVNode(_component_FigureNumber),
      _cache[4] || (_cache[4] = createTextVNode(" below."))
    ]),
    createVNode(_component_Figure, { caption: "Sample input/output of the program." }, {
    ...
    _cache[129] || (_cache[129] = createBaseVNode(
      "h3",
      {
        id: "problem-1-6-computing-products",
        tabindex: "-1"
      },
      [
        createBaseVNode("a", {
          class: "header-anchor",
          href: "#problem-1-6-computing-products",
          "aria-hidden": "true"
        }, "#"),
        createTextVNode(" Problem 1.6: Computing products")
      ],
      -1
      /* HOISTED */
    )),
    createBaseVNode("p", null, [
      _cache[6] || (_cache[6] = createTextVNode("Create a program that asks the user to enter two integers. The program should then compute and print the product of the integers between (and including) these two integers. For example, the product of the integers between ")),
      ...
      _cache[8] || (_cache[8] = createTextVNode(" and ")),
      ...
      _cache[10] || (_cache[10] = createTextVNode(" is ")),
      ...
      _cache[14] || (_cache[14] = createTextVNode(". Assume the user enters the lower integer first. It can look like as shown in ")),
      createVNode(_component_FigureNumber),
      _cache[15] || (_cache[15] = createTextVNode(" below."))
    ]),
    createVNode(_component_Figure, { caption: "Sample input/output of the program." }, {
    ...
    _cache[131] || (_cache[131] = createBaseVNode(
      "h4",
      {
        id: "sustainable-building-information-management",
        tabindex: "-1"
      },
      [
        createBaseVNode("a", {
          class: "header-anchor",
          href: "#sustainable-building-information-management",
          "aria-hidden": "true"
        }, "#"),
        createTextVNode(" Sustainable Building Information Management")
      ],
      -1
      /* HOISTED */
    )),
    createBaseVNode("p", null, [
      _cache[20] || (_cache[20] = createTextVNode("Create a program that can calculate LCC for a building using the information in ")),
      createVNode(_component_FigureNumber),
      _cache[21] || (_cache[21] = createTextVNode(" below:"))
    ]),
    createVNode(_component_Figure, { caption: "Slides with the LCC formula and the Present Value Factor" }, {
    ...
    createVNode(_component_Figure, { caption: "IDS" }, {
    ...
    createBaseVNode("ul", null, [
      ...
      createBaseVNode("li", null, [
        _cache[25] || (_cache[25] = createTextVNode("The environmental cost should be calculated with the compensation factor 0.72SKR/CO2eq according ")),
        createBaseVNode("a", _hoisted_1, [
          _cache[24] || (_cache[24] = createTextVNode("https://co2kompensera.se/")),
    ...
    _cache[134] || (_cache[134] = createBaseVNode(
      ...
      [
        ...
        createTextVNode(" Present your work")
      ],
      -1
      /* HOISTED */
    )),
    ...
    createBaseVNode("p", null, [
      _cache[35] || (_cache[35] = createTextVNode("When the teacher is satisfied with your presentation, upload your Python files to the assignment ")),
      createBaseVNode("a", _hoisted_2, [
        _cache[34] || (_cache[34] = createTextVNode("Lab 1 Code")),
        createVNode(_component_ExternalLinkIcon)
      ]),
      _cache[36] || (_cache[36] = createTextVNode(" on Canvas. The teacher will then approve you on that assignment."))
    ]),
    _cache[136] || (_cache[136] = createStaticVNode('<h2 id="lab-2-functions-and-modules" tabindex="-1"><a class="header-anchor" href="#lab-2-functions-and-modules" aria-hidden="true">#</a> Lab 2 - Functions and Modules</h2><div class="custom-container warning"><p class="custom-container-title">Note!</p><p>Before you attempt solving the programming problems in Lab 2 you are strongly recommended to solve the programming problems in Exercise 2 and watch the recorded lectures mentioned there.</p></div><h3 id="problem-2-1-writing-lyrics" tabindex="-1"><a class="header-anchor" href="#problem-2-1-writing-lyrics" aria-hidden="true">#</a> Problem 2.1: Writing lyrics</h3>', 3)),
    createBaseVNode("p", null, [
      _cache[37] || (_cache[37] = createTextVNode("Create a program that prints the lyrics for the song ")),
      ...
      _cache[39] || (_cache[39] = createTextVNode(". It can look as shown in ")),
      createVNode(_component_FigureNumber),
      _cache[40] || (_cache[40] = createTextVNode(" below."))
    ]),
    createVNode(_component_Figure, { caption: "The lyrics for the song We wish you a merry Christmas." }, {
    ...
    createVNode(_component_Figure, { caption: "Sample input to and output from the program." }, {
      default: withCtx(() => _cache[44] || (_cache[44] = [
        createBaseVNode(
          ...
          [
            createBaseVNode("pre", { class: "language-text" }, [
              createBaseVNode("code", null, "Enter multiplication table: 5\nEnter number of questions: 3\nWhat is 5 * 6?\nEnter answer: 20\nCorrect answer is 30.\nWhat is 5 * 2?\nEnter answer: 10\nCorrect answer is 10.\nWhat is 5 * 8?\nEnter answer: 45\nCorrect answer is 40.\n")
            ]),
            createBaseVNode("div", {
              class: "line-numbers",
              "aria-hidden": "true"
    ...
    _cache[140] || (_cache[140] = createBaseVNode(
      "h3",
      {
        id: "present-your-work-2",
        tabindex: "-1"
      },
      [
        createBaseVNode("a", {
          class: "header-anchor",
          href: "#present-your-work-2",
          "aria-hidden": "true"
        }, "#"),
        createTextVNode(" Present your work")
      ],
    ...
    createBaseVNode("p", null, [
      _cache[52] || (_cache[52] = createTextVNode("When the teacher is satisfied with your presentation, upload your Python files to the assignment ")),
      createBaseVNode("a", _hoisted_4, [
        _cache[51] || (_cache[51] = createTextVNode("Lab 3 Code")),
        createVNode(_component_ExternalLinkIcon)
      ]),
      _cache[53] || (_cache[53] = createTextVNode(" on Canvas. The teacher will then approve you on that assignment."))
    ]),
    _cache[142] || (_cache[142] = createStaticVNode('<h2 id="lab-4-lists-dicts" tabindex="-1"><a class="header-anchor" href="#lab-4-lists-dicts" aria-hidden="true">#</a> Lab 4 - Lists &amp; Dicts</h2><div class="custom-container warning"><p class="custom-container-title">Note!</p><p>Before you attempt solving the programming problems in Lab 4 you are strongly recommended to solve the programming problems in Exercise 4 and watch the recorded lectures mentioned there.</p></div><h3 id="problem-4-1-comparing-two-lists" tabindex="-1"><a class="header-anchor" href="#problem-4-1-comparing-two-lists" aria-hidden="true">#</a> Problem 4.1: Comparing two lists</h3><p>Create the function <code>are_equal()</code>, which receives two lists with numbers as arguments and returns <code>True</code> if the number at each index in the two lists are equal, otherwise <code>False</code>.</p><p>Sample usage:</p><ul><li><code>are_equal([1, 2, 3], [1, 2, 3])</code> → <code>True</code></li><li><code>are_equal([1, 2, 3], [1, 2, 2])</code> → <code>False</code></li><li><code>are_equal([1, 2, 3], [1, 2])</code> → <code>False</code></li><li><code>are_equal([1, 2], [1, 2, 3])</code> → <code>False</code></li></ul><div class="custom-container danger"><p class="custom-container-title">Don&#39;t!</p><p>It is not allowed to use built-in functionality to compare lists, such as:</p><ul><li><code>a_list == another_list</code></li><li><code>a_list != another_list</code></li><li><code>a_list &lt; another_list</code></li><li><code>a_list &gt; another_list</code></li></ul><p>But feel free to use the operators to compare numbers, such as <code>a_number == another_number</code>.</p></div><div class="custom-container tip"><p class="custom-container-title">Tips!</p><p>When implementing this function, you somehow need to compare the elements pairwise. The simplest way to do that is by iterating over the indexes in the lists, but that can get you into trouble if the two lists do not contain the same number of elements.</p></div><h3 id="problem-4-2-changing-a-list" tabindex="-1"><a class="header-anchor" href="#problem-4-2-changing-a-list" aria-hidden="true">#</a> Problem 4.2: Changing a list</h3><p>Create the function <code>change_to_highest()</code>, which receives a list as argument. The received list will contain lists with numbers, and the function should change the received list so it contains the highest number from each nested list.</p>', 10)),
    createBaseVNode("p", null, [
      _cache[54] || (_cache[54] = createTextVNode("A sample usage is shown in ")),
      createVNode(_component_FigureNumber),
      _cache[55] || (_cache[55] = createTextVNode(" below."))
    ]),
    createVNode(_component_Figure, { caption: "Sample usage of the function." }, {
          ...
          [
            createBaseVNode("pre", { class: "language-python" }, [
              createBaseVNode("code", null, [
                ...
                createBaseVNode("span", { class: "token punctuation" }, ")"),
                createTextVNode(),
                createBaseVNode("span", { class: "token comment" }, "# → None (no return value!)."),
                createTextVNode("\n"),
                createBaseVNode("span", { class: "token comment" }, "# the_list should now be [3, 5, 7]."),
                createTextVNode("\n")
              ])
            ]),
            createBaseVNode("div", {
    ...
    createBaseVNode("p", null, [
      ...
      _cache[62] || (_cache[62] = createTextVNode(" In ")),
      createVNode(_component_FigureNumber),
      _cache[63] || (_cache[63] = createTextVNode(" below you can see the naming principles of files that are related to CAD."))
    ]),
    createVNode(_component_Figure, { caption: "" }, {
    ...
    _cache[146] || (_cache[146] = createBaseVNode(
      "h3",
      {
        id: "present-your-work-3",
        tabindex: "-1"
      },
      [
        createBaseVNode("a", {
          class: "header-anchor",
          href: "#present-your-work-3",
          "aria-hidden": "true"
        }, "#"),
        createTextVNode(" Present your work")
      ],
    ...
    createBaseVNode("p", null, [
      _cache[69] || (_cache[69] = createTextVNode("When the teacher is satisfied with your presentation, upload your Python files to the assignment ")),
      createBaseVNode("a", _hoisted_5, [
        _cache[68] || (_cache[68] = createTextVNode("Lab 4 Code")),
        createVNode(_component_ExternalLinkIcon)
      ]),
      _cache[70] || (_cache[70] = createTextVNode(" on Canvas. The teacher will then approve you on that assignment."))
    ]),
    _cache[148] || (_cache[148] = createStaticVNode('<h2 id="lab-5-working-with-files" tabindex="-1"><a class="header-anchor" href="#lab-5-working-with-files" aria-hidden="true">#</a> Lab 5 - Working with files</h2><div class="custom-container warning"><p class="custom-container-title">Note!</p><p>Before you attempt solving the programming problems in Lab 5 you are strongly recommended to solve the programming problems in Exercise 5 and watch the recorded lectures mentioned there.</p></div><h3 id="problem-5-1-counting-things" tabindex="-1"><a class="header-anchor" href="#problem-5-1-counting-things" aria-hidden="true">#</a> Problem 5.1: Counting things</h3>', 3)),
    createBaseVNode("p", null, [
      _cache[71] || (_cache[71] = createTextVNode("Create a file named ")),
      ...
      _cache[73] || (_cache[73] = createTextVNode(" with the content shown in ")),
      createVNode(_component_FigureNumber),
      _cache[74] || (_cache[74] = createTextVNode(" below. Then write a program that computes and prints:"))
    ]),
    _cache[149] || (_cache[149] = createBaseVNode(
      "ul",
      null,
      [
        createBaseVNode("li", null, "The number of words in the file."),
        createBaseVNode("li", null, "The number of sentences in the file."),
        createBaseVNode("li", null, "The number of paragraphs in the file."),
        createBaseVNode("li", null, "Which of the letters (a-z) that appears most times (count upper case letters as lower case letters) and how many times that is.")
      ],
      -1
      /* HOISTED */
    )),
    createVNode(_component_Figure, null, {
    ...
    createBaseVNode("p", null, [
      ...
      _cache[78] || (_cache[78] = createTextVNode(" with the XML code shown in ")),
      createVNode(_component_FigureNumber),
      _cache[79] || (_cache[79] = createTextVNode(" below. The XML code contains information about a house with a set of rectangular rooms."))
    ]),
    createVNode(_component_Figure, { caption: "The XML code in house.xml." }, {
    ...
    _cache[152] || (_cache[152] = createBaseVNode(
      "h4",
      {
        id: "it-infrastructure-and-network-design-2",
        tabindex: "-1"
      },
      [
        createBaseVNode("a", {
          class: "header-anchor",
          href: "#it-infrastructure-and-network-design-2",
          "aria-hidden": "true"
        }, "#"),
        createTextVNode(" IT Infrastructure and Network Design")
      ],
      -1
      /* HOISTED */
    )),
    createBaseVNode("p", null, [
      _cache[81] || (_cache[81] = createTextVNode("Write a default configuration for a Cisco router in a file called ")),
      ...
      _cache[83] || (_cache[83] = createTextVNode(". In this file, you should be able to use placeholders that later will be replaced with the actual values that should be used. The file can look like the one shown in ")),
      createVNode(_component_FigureNumber),
      _cache[84] || (_cache[84] = createTextVNode(" below. In this case, placeholders are all words surrounded with curly brackets, ")),
    ...
    createVNode(_component_Figure, { caption: "Sample of the configuration template file. The parts with curly brackets are placeholders." }, {
    ...
    createBaseVNode("p", null, [
      _cache[88] || (_cache[88] = createTextVNode("Then create another file called ")),
      _cache[89] || (_cache[89] = createBaseVNode(
        "code",
        null,
        "configuration-values.csv",
        -1
        /* HOISTED */
      )),
      _cache[90] || (_cache[90] = createTextVNode(", that contains the value for each placeholder in the configuration template. Furthermore, it does not only contain one value for each placeholder, but a list of them. It can look like the one shown in ")),
      createVNode(_component_FigureNumber),
      _cache[91] || (_cache[91] = createTextVNode(" below, in this case 5 values for each placeholder (the name of the placeholder is the first value on each line)."))
    ]),
    createVNode(_component_Figure, { caption: "Sample of the configuration template file. The parts with curly brackets are placeholders." }, {
    ...
    createBaseVNode("p", null, [
      _cache[93] || (_cache[93] = createTextVNode("Instead of manually creating the CSV file yourself, you can easily create and maintain it using Microsoft Excel, as shown in ")),
      createVNode(_component_FigureNumber),
      _cache[94] || (_cache[94] = createTextVNode(" below. When saving the file, just save it as ")),
      ...
      _cache[96] || (_cache[96] = createTextVNode(" instead of ")),
    ...
    createVNode(_component_Figure, { caption: "Saving an Excell document as a CSV file." }, {
    ...
    _cache[153] || (_cache[153] = createBaseVNode(
      ...
      null,
      [
        createTextVNode("Your task is to create a program that reads the placeholder values from "),
        createBaseVNode("code", null, "configuration-values.csv"),
        createTextVNode(" and then generates new configuration files based on the template in "),
        createBaseVNode("code", null, "configuration-template.config"),
        createTextVNode(", but where the placeholders have been replaced with the values.")
      ],
      -1
      /* HOISTED */
    )),
    createBaseVNode("p", null, [
      _cache[100] || (_cache[100] = createTextVNode("With the two files given above, your program should generate 5 new configuration files, the first one looking like the one shown in ")),
      createVNode(_component_FigureNumber),
      _cache[101] || (_cache[101] = createTextVNode(" below."))
    ]),
    createVNode(_component_Figure, { caption: "Sample of what the first generated configuration file can look like." }, {
    ...
    createBaseVNode("p", null, [
      ...
      _cache[109] || (_cache[109] = createTextVNode(", and it can be used to play the game ")),
      createBaseVNode("a", _hoisted_7, [
        _cache[106] || (_cache[106] = createTextVNode("Connect Four")),
        createVNode(_component_ExternalLinkIcon)
      ]),
      _cache[110] || (_cache[110] = createTextVNode(". Instead of red and yellow bricks, we will use ")),
      ...
      _cache[112] || (_cache[112] = createTextVNode(" and ")),
      ...
      _cache[114] || (_cache[114] = createTextVNode(" to represent the different players."))
    ]),
    _cache[156] || (_cache[156] = createStaticVNode('<p>The file <a href="files/labs/ConnectFour.py">ConnectFour.py</a> contains the <code>ConnectFour</code> class you should use. Add the code in that file to your own Python file. Then create a new instance of the class (the object that stores the state of the game) by calling the constructor of the class, e.g.:</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code>game <span class="token operator">=</span> ConnectFour<span class="token punctuation">(</span><span class="token number">7</span><span class="token punctuation">)</span>\n</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>When you call the constructor, you pass it the number of rows the game should have (in this case <code>7</code>). The game will always have 10 columns.</p><p>To use the game object, you can call different methods on it. The different methods will tell the object to do different things. To tell the object to print itself to the console, call the <code>print_game()</code> method:</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code>game<span class="token punctuation">.</span>print_game<span class="token punctuation">(</span><span class="token punctuation">)</span>\n</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>', 5)),
    createBaseVNode("p", null, [
      _cache[115] || (_cache[115] = createTextVNode("This method prints the game as shown in ")),
      createVNode(_component_FigureNumber),
      _cache[116] || (_cache[116] = createTextVNode(" below."))
    ]),
    createVNode(_component_Figure, { caption: "What the game looks like printed to the console/terminal/shell. The numbers at the bottom identify the different columns (the first column is 0)." }, {
    ...
    createBaseVNode("p", null, [
      ...
      _cache[121] || (_cache[121] = createTextVNode(" class correctly, it should work well with the code found in ")),
      createVNode(_component_FigureNumber),
      _cache[122] || (_cache[122] = createTextVNode(" below, which contains the main application loop for the calculator program."))
    ]),
    createVNode(_component_Figure, { caption: "The main application loop for the calculator program implemented with the Calculator class." }, {
      default: withCtx(() => _cache[123] || (_cache[123] = [
        createBaseVNode(
          ...
          [
            createBaseVNode("pre", { class: "language-python" }, [
              createBaseVNode("code", null, [
                createTextVNode("initial_memory_value "),
                createBaseVNode("span", { class: "token operator" }, "="),
                createTextVNode(),
                ...
                createBaseVNode("span", { class: "token punctuation" }, "("),
                createBaseVNode("span", { class: "token string" }, '"Enter initial memory value: "'),
                createBaseVNode("span", { class: "token punctuation" }, ")"),
                createBaseVNode("span", { class: "token punctuation" }, ")"),
                createTextVNode("\ncalculator "),
                createBaseVNode("span", { class: "token operator" }, "="),
                ...
                createBaseVNode("span", { class: "token builtin" }, "input"),
                createBaseVNode("span", { class: "token punctuation" }, "("),
                createBaseVNode("span", { class: "token string" }, '"Enter operation (add/sub/mul/div/undo/quit): "'),
                createBaseVNode("span", { class: "token punctuation" }, ")"),
                createTextVNode("\n	\n	"),
                ...
                createBaseVNode("span", { class: "token operator" }, "=="),
                createTextVNode(),
                createBaseVNode("span", { class: "token string" }, '"undo"'),
                createBaseVNode("span", { class: "token punctuation" }, ":"),
                createTextVNode("\n		"),
                createBaseVNode("span", { class: "token keyword" }, "if"),
                createTextVNode(" calculator"),
                createBaseVNode("span", { class: "token punctuation" }, "."),
                createTextVNode("can_undo"),
                createBaseVNode("span", { class: "token punctuation" }, "("),
                createBaseVNode("span", { class: "token punctuation" }, ")"),
                createBaseVNode("span", { class: "token punctuation" }, ":"),
                createTextVNode("\n			calculator"),
                ...
                createTextVNode("calculator"),
                createBaseVNode("span", { class: "token punctuation" }, "."),
                createTextVNode("get_memory_value"),
                createBaseVNode("span", { class: "token punctuation" }, "("),
                createBaseVNode("span", { class: "token punctuation" }, ")"),
                createBaseVNode("span", { class: "token punctuation" }, ")"),
                createBaseVNode("span", { class: "token operator" }, "+"),
                createBaseVNode("span", { class: "token string" }, '" is stored in memory."'),
                createBaseVNode("span", { class: "token punctuation" }, ")"),
                createTextVNode("\n		"),
                ...
                createBaseVNode("span", { class: "token keyword" }, "print"),
                createBaseVNode("span", { class: "token punctuation" }, "("),
                createBaseVNode("span", { class: "token string" }, '"There is nothing to undo."'),
                createBaseVNode("span", { class: "token punctuation" }, ")"),
                createTextVNode("\n	"),
                ...
                createBaseVNode("span", { class: "token builtin" }, "input"),
                createBaseVNode("span", { class: "token punctuation" }, "("),
                createBaseVNode("span", { class: "token string" }, '"Enter operand: "'),
                createBaseVNode("span", { class: "token punctuation" }, ")"),
                createBaseVNode("span", { class: "token punctuation" }, ")"),
                createTextVNode("\n		\n		"),
                createBaseVNode("span", { class: "token keyword" }, "if"),
                ...
                createBaseVNode("span", { class: "token operator" }, "=="),
                createTextVNode(),
                createBaseVNode("span", { class: "token string" }, '"sub"'),
                createBaseVNode("span", { class: "token punctuation" }, ":"),
                createTextVNode("\n			calculator"),
                createBaseVNode("span", { class: "token punctuation" }, "."),
                createTextVNode("subtract"),
                createBaseVNode("span", { class: "token punctuation" }, "("),
                createTextVNode("operand"),
                createBaseVNode("span", { class: "token punctuation" }, ")"),
                createTextVNode("\n		"),
                ...
                createBaseVNode("span", { class: "token operator" }, "=="),
                createTextVNode(),
                createBaseVNode("span", { class: "token string" }, '"mul"'),
                createBaseVNode("span", { class: "token punctuation" }, ":"),
                createTextVNode("\n			calculator"),
                createBaseVNode("span", { class: "token punctuation" }, "."),
                createTextVNode("multiply"),
                createBaseVNode("span", { class: "token punctuation" }, "("),
                createTextVNode("operand"),
                createBaseVNode("span", { class: "token punctuation" }, ")"),
                createTextVNode("\n		"),
                ...
                createBaseVNode("span", { class: "token operator" }, "=="),
                createTextVNode(),
                createBaseVNode("span", { class: "token string" }, '"div"'),
                createBaseVNode("span", { class: "token punctuation" }, ":"),
                createTextVNode("\n			calculator"),
                createBaseVNode("span", { class: "token punctuation" }, "."),
                createTextVNode("divide"),
                createBaseVNode("span", { class: "token punctuation" }, "("),
                createTextVNode("operand"),
                createBaseVNode("span", { class: "token punctuation" }, ")"),
                createTextVNode("\n		\n		"),
                ...
                createBaseVNode("span", { class: "token keyword" }, "print"),
                createBaseVNode("span", { class: "token punctuation" }, "("),
                createBaseVNode("span", { class: "token string" }, '"The program finished with "'),
                createBaseVNode("span", { class: "token operator" }, "+"),
                createBaseVNode("span", { class: "token builtin" }, "str"),
                createBaseVNode("span", { class: "token punctuation" }, "("),
                createTextVNode("calculator"),
                ...
                createBaseVNode("span", { class: "token punctuation" }, ")"),
                createBaseVNode("span", { class: "token operator" }, "+"),
                createBaseVNode("span", { class: "token string" }, '" in memory."'),
                createBaseVNode("span", { class: "token punctuation" }, ")"),
                createTextVNode("\n")
              ])
            ]),
    ...
    _cache[159] || (_cache[159] = createBaseVNode(
      "h3",
      {
        id: "present-your-work-5",
        tabindex: "-1"
      },
      [
        createBaseVNode("a", {
          class: "header-anchor",
          href: "#present-your-work-5",
          "aria-hidden": "true"
        }, "#"),
        createTextVNode(" Present your work")
      ],
    ...
    _cache[161] || (_cache[161] = createBaseVNode(
      "div",
      { class: "custom-container warning" },
      [
        createBaseVNode("p", { class: "custom-container-title" }, "Note!"),
        createBaseVNode("p", null, "The difficulties in this lab is not to write much code (most of the code you've written has been given to you), but to understand what code to write, and how that code works. Your oral presentation should reflect that you really understand how the code you've written works.")
      ],
      -1
      /* HOISTED */
    )),
    createBaseVNode("p", null, [
      _cache[125] || (_cache[125] = createTextVNode("When the teacher is satisfied with your presentation, upload your Python files to the assignment ")),
      createBaseVNode("a", _hoisted_8, [
        _cache[124] || (_cache[124] = createTextVNode("Lab 6 Code")),
        createVNode(_component_ExternalLinkIcon)
      ]),
      _cache[126] || (_cache[126] = createTextVNode(" on Canvas. The teacher will then approve you on that assignment."))
    ])
  ]);
}
