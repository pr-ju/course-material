import { _ as _export_sfc, r as resolveComponent, o as openBlock, c as createElementBlock, f as createStaticVNode, d as createVNode, a as createBaseVNode } from "./app-dfab54cf.js";
const _sfc_main = {};
function _sfc_render(_ctx, _cache) {
  ...
  return openBlock(), createElementBlock("div", null, [
    ...
    _cache[1] || (_cache[1] = createBaseVNode(
      ...
      [
        createBaseVNode("p", { class: "custom-container-title" }, "Re-exam periods not included"),
        createBaseVNode("p", null, "The two re-exam periods that are also part of the course are not shown in the Time Plan above, but those basically gives you 40 additional hours to finish the course in.")
      ],
      -1
      /* HOISTED */
    ))
